...
The plot below shows the tooth growth ranges for each dosage level.
...
An alternate view of the data is to compate tooth growth ranges for each 
supplement.

```{r, echo=TRUE}
g <- ggplot(data, aes(x = dose, y = len, fill = supp)) +
    geom_boxplot() +
    facet_grid(. ~ supp) + 
